...
KC Health CORE is a collaborative initiative between Children’s Mercy Hospital and the Center for Economic Information at the University of Missouri, Kansas City created to investigate the geographic disparity of pediatric health outcomes. This analysis will use pediatric asthma data from 2001-2012 geocoded to street centerlines based on the patients’ home address at the time of admission (Fig. \@ref(fig:asthma)). Although the dataset contains information on the years 1999 and 2001, the observations seem inconsistent with the remaining years. It is likely that this is due to differences in data procedures and those years will not be considered. It is also likely that more data will be made available during the course of this research with observations through 2019. The data come from a retrospective collection of pediatric asthma encounters within the Children’s Mercy Hospital network. In this instance children ages 2-18 are considered as asthma is difficult to diagnose in young children [@kaneInterdisciplinaryHealthDisparities2020; @trivediAsthmaChildrenAdults2019]. The original medical records were formatted according to Table \@ref(tab:original-asthma-data).
...
The data were further classified into three severity levels according to the International Classification of Diseases, 9^th^ revision diagnoses codes (ICD-9) and the patient class: (1) controlled visit, (2) acute care visit, and (3) hospitalization. The patient class records both the location and the type of treatment received by the patient–e.g. controlled vs. acute care, inpatient vs. outpatient, etc. Level one visits are controlled encounters that do not necessarily indicate presentation of symptoms but could be used to identify the general pediatric asthma population. Level two visits are acute care visits for immediate symptoms at same-day clinics and emergency departments. Level three visits are the most severe, requiring hospitalization and/or aggressive treatment. An additional considerartion is that the Children's Mercy Hospital (CMH) network---while serving all children within the Kansas City Metropolitan Area---will not capture all of the pediatric population. However, as the only facilities that specialize in pediatric care, the network is likely to capture most of the acute and most severe cases as emergency patients are typically transfered there from other facilities. See @kaneInterdisciplinaryHealthDisparities2020 for more details and to read her excellent work.
