...
KC Health CORE is a collaborative initiative between Children’s Mercy Hospital (CMH) and the Center for Economic Information (CEI) at the University of Missouri, Kansas City created to investigate the geographic disparity of pediatric health outcomes. This analysis will use pediatric asthma data from 2001-2012 geocoded to street centerlines based on the patients’ home address at the time of admission (Fig. \@ref(fig:asthma)). These observations are readily aggregated to counts or rates per space-time interval. Although the dataset contains information on the years 1999 and 2001, the observations are inconsistent with the remaining years, likely due to differences in data procedures. These will not be considered. More data will be made available during the course of this research with observations through 2019 and will be incorporated as is possible. The data come from a retrospective collection of pediatric asthma encounters within the CMH network. Only children ages 2-18 are considered as asthma is difficult to diagnose in very young children [@kaneInterdisciplinaryHealthDisparities2020; @trivediAsthmaChildrenAdults2019]. The original medical records were formatted according to Table \@ref(tab:original-asthma-data) [@kaneInterdisciplinaryHealthDisparities2020].
