...
Preliminary analysis of the Kansas City pediatric asthma data highlights some of the limitations of simple modeling techniques. 
...
```{r LST-pctmin-quant, fig.cap = cap}
...
all.levels %>%
  ...
  facet_wrap(~ month(Date), scales = "free_x", ncol = 1)
```
